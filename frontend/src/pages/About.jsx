...
const timeline = [
  { phase: "Phase 1", title: "Project Planning & Repository Setup", status: "done" },
  { phase: "Phase 2", title: "Frontend Skeleton & UI Components", status: "done" },
  { phase: "Phase 3", title: "Backend API & Database Setup", status: "done" },
  { phase: "Phase 4", title: "AI Integration with Gemini API", status: "done" },
  { phase: "Phase 5", title: "Dashboard Analytics & Charts", status: "done" },
  { phase: "Phase 6", title: "Testing, Polish & Production", status: "done" },
]
            ...
            <div className="space-y-6">
              {timeline.map((t, i) => (
                <div key={t.phase} className="reveal relative pl-12 sm:pl-14" style={{ transitionDelay: `${i * 0.08}s` }}>
                  ...
                  />
                  <div className={`rounded-xl p-4 transition-all ${t.status === "current"
                    ...
                    <div className="flex items-center gap-3">
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md ${t.status === "done"
