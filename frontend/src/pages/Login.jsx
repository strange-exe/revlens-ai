          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button
                  type="button"
                  className="text-[10px] font-semibold text-(--color-brand-500) dark:text-(--color-gold-400) hover:underline cursor-pointer bg-transparent border-none p-0"
                >
                  Forgot?
                </button>
              </div>
